...
public class ThingAspectService implements EnolaService {

    private final Type type;
    private final ImmutableList<ThingAspect> registry;
    private final EnolaMessages enolaMessages;

    public ThingAspectService(
            Type type, ImmutableList<ThingAspect> aspects, EnolaMessages enolaMessages) {
        this.type = type;
        this.registry = aspects;
        this.enolaMessages = enolaMessages;
    }
